...
Route::controller(BudgetController::class)->group(function () {
    Route::get('budgets', 'index')->name(name: 'budgets.index');
    Route::get('budgets/create', 'create')->name('budgets.create');
    Route::post('budgets/create', 'store')->name(name: 'budgets.store');
...
Route::controller(ExpenseController::class)->group(function () {
    Route::get('expenses', 'index')->name(name: 'expenses.index');
    Route::get('expenses/create', 'create')->name('expenses.create');
    Route::post('expenses/create', 'store')->name(name: 'expenses.store');
...
Route::controller(NetWorthController::class)->group(function () {
    Route::get('net-worths', 'index')->name(name: 'net-worths.index');
    Route::get('net-worths/create', 'create')->name('net-worths.create');
    Route::post('net-worths/create', 'store')->name(name: 'net-worths.store');
